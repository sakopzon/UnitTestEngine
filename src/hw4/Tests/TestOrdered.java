...
public class TestOrdered {
	...
	@OOPTest(order = 8,testThrows = true,exception = OOPAssertionFailure.class)
	public void test8() // this should be a success test
	{
		fail();
	}
	@OOPTest(order = 9,testThrows = true,exception = ExceptionDummy.class)
	public void test9() // we expect exception dummy but get AssertionFail therefore should fail
	{
		fail();
	}
	@OOPTest(order = 10,testThrows = true,exception = OOPAssertionFailure.class)
